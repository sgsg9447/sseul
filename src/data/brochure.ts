...
export const hero = {
  // 리뉴얼이 주력이되, 신규 제작도 한다는 걸 카테고리에서부터 드러낸다.
  eyebrow: 'WEB BUILD & RENEWAL · 웹사이트 제작·리뉴얼',
  // 핵심 어구만 주황으로 강조한다(브랜드 규칙: 주황은 아껴 쓴다).
  title: { line1: '안 되던 웹사이트를,', hl: '다시 일하게', rest: ' 만듭니다.' },
  // 항상 2줄로 끊어 보여준다 — 1줄: 신규(없어도)+리뉴얼(오래됐어도), 2줄: 범위·책임.
  ledeLines: [
    '사이트가 없어도, 오래됐어도 괜찮습니다.',
    '소개 한 장부터 풀 리뉴얼까지 기획·구현·운영을 한 사람이 끝까지 맡습니다.',
  ],
