...
export const profileHero = {
  ...
  card: {
    ...
    rows: [
      ...
      { label: '시작가', value: 'PDF 25,000원~ / 웹 149,000원~' },
...
export const faqs: { q: string; a: string }[] = [
  ...
  { q: '수정은 몇 번까지 되나요?', a: '상품별 기본 수정 횟수가 있고, 큰 방향 변경이 아니면 유연하게 반영합니다.' },
  { q: '급한데 언제까지 되나요?', a: 'PDF는 보통 2~3일, 웹은 약 1주입니다. 급한 일정은 미리 말씀해 주세요.' },
];
