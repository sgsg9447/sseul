  ...
  return (
    <div className="hoonjo-timeline-item" style={{ position: 'relative', display: 'grid', gridTemplateColumns: '150px 1fr', gap: 28, paddingBottom: 40, ...style }}>
      ...
      <div>
        ...
        {description && <p style={{ fontFamily: 'var(--font-sans)', fontSize: 15, lineHeight: 1.6, color: 'var(--text-secondary)', marginTop: 10, maxWidth: '54ch', whiteSpace: 'pre-line' }}>{description}</p>}
        {tags.length > 0 && (
